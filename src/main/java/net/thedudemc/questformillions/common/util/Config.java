...
public class Config {
	...
	// diamond stick
	public static int diamondStick_rarity;
	...
	public static void init(File file) {
		...
		totemOfRain_rarity = config.getInt("rarity", "totem_of_rain", 3, 1, 50, "Set the chance that the Totem of Rain will spawn in chests! For reference, a Enchanted Golden Apple is 2 by default and a saddle is 20.");
		...
		diamondStick_rarity = config.getInt("rarity", "diamond_stick", 5, 1, 50, "Set the chance that the Diamond Stick will spawn in chests! For reference, a Enchanted Golden Apple is 2 by default and a saddle is 20.");
